...
namespace yiiComponent\restApi\generators\crudUp;
...
class Generator extends \yii\gii\Generator
{
    ...
    public $viewPath;
    public $baseControllerClass = '\yiiComponent\restApi\restAction\RestActiveController';
    ...
    {
        return 'REST Api CRUD-up Generator';
    }
    ...
    public function generate()
    {
        ...
        // Create dirs
        $dir = pathinfo($controllerFile);
        $this->directory($dir['dirname']);
        $files = [
